...
class LoKrLayer(nn.Module, LycorisLayer):
    ...
    def _available_adapters(self) -> Set[str]:
        return {
            *list(self.lokr_w1.keys()),
            *list(self.lokr_w1_a.keys()),
            *list(self.lokr_w1_b.keys()),
            *list(self.lokr_w2.keys()),
            *list(self.lokr_w2_a.keys()),
            *list(self.lokr_w2_b.keys()),
            *list(self.lokr_t2.keys()),
        }
    ...
    def reset_adapter_parameters(self, adapter_name: str):
        # print(self.lokr_w1.keys())
        if adapter_name in list(self.lokr_w1.keys()):
        ...
        if adapter_name in list(self.lokr_w2.keys()):
        ...
        if adapter_name in list(self.lokr_t2.keys()):
    ...
    def get_delta_weight(self, adapter_name: str) -> torch.Tensor:
        ...
        elif adapter_name in list(self.lokr_t2.keys()):
